...
\begin{description}
  \item[Keine Aktualisierungen der gesamten Seite]In einer \ac{SPA} werden Views
    ...
    \item[Trennung von Client und Server]Durch die Verlagerung der
      ...
      Entkopplung ist bekannt unter dem ``single responsibility principle'' Entwurfsmuster\footnote{https://blog.cleancoder.com/uncle-bob/2014/05/08/SingleReponsibilityPrinciple.html}.
\end{description}
